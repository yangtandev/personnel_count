...
config = {
    ...
    "crossing": {
        ...
        "side_confirm_sec": 0.12,
        "confirmation_distance_ratio": 0.10,
        "motion_confirmation_distance_ratio": 0.05,
        "display_min_motion_box_ratio": 0.03,
        ...
        "appearance_max_distance": 0.25,
        "appearance_handoff_timeout_sec": 2.0,
        "appearance_association_max_distance_ratio": 1.0,
        "use_detection_point": True,
        "lines": {},
    },
    "direction": {
        "top": {"positive_to_negative": "enter", "negative_to_positive": "exit"},
        "bottom": {"positive_to_negative": "exit", "negative_to_positive": "enter"},
    },
    "storage": {
